...
export const promos = [
  {
    ...
    description: "Замовляй будь-які дві піци і отримай третю меншу безкоштовно. Діє на доставку та самовивіз.",
    badge: "Акція",
  ...
  },
  {
    ...
    description: "Щодня з 11:00 до 16:00 — знижка на всі суші-сети.",
    badge: "Happy Hours",
    image: "https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=900&q=80",
    href: "/menu?category=rolls",
  },
  {
    id: 3,
    title: "Самовивіз −20%",
    description: "Забирай замовлення сам і отримуй постійну знижку на піци та бургери.",
    badge: "Знижка",
  ...
  {
    id: 4,
    title: "Подарунок від 750 грн",
    description: "За кожні 750 грн замовлення — піца або рол у подарунок на вибір.",
    badge: "Подарунок",
