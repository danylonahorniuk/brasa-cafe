...
export const promos = [
  ...
  },
  {
    ...
    label: "21:00–23:00",
    title: "Нічна акція",
    subtitle: "Піца + роли + напій за спецціною",
    description: "Щовечора з 21:00 до 23:00 — спеціальне нічне комбо за вигідною ціною. Тільки на доставку.",
    href: "/menu",
  },
  {
    id: 8,
    icon: "🍔",
    label: "1+1",
    title: "Бургер у подарунок",
    subtitle: "Піцоне 1+1 по буднях",
    description: "З понеділка по четвер з 21:00 до 22:00 — замов бургер і отримай такий самий у подарунок. Діє на самовивіз.",
