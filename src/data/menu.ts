...
export const promos = [
  {
    ...
    value: "3+1",
    valueLabel: "піци",
    title: "Третя піца — в подарунок",
    description: "Замовляй будь-які дві піци і отримай третю безкоштовно. Діє на доставку та самовивіз.",
    badge: "Акція",
  ...
  },
  {
    ...
    value: "11–16",
    valueLabel: "щодня",
    title: "Happy Hours на суші",
    description: "Щодня з 11:00 до 16:00 — спеціальна ціна на всі суші-сети та роли.",
    badge: "Щодня",
  ...
  },
  {
    id: 3,
    value: "−20%",
    valueLabel: "самовивіз",
    title: "Знижка при самовивозі",
    description: "Постійна знижка 20% на всі піци та бургери. Просто забери замовлення сам.",
    badge: "Знижка",
  ...
  },
  {
    id: 4,
    value: "750₴",
    valueLabel: "і подарунок",
    title: "Бонус за суму замовлення",
    description: "За кожні 750 грн у чеку — піца або рол безкоштовно на твій вибір.",
    badge: "Подарунок",
    href: "/menu",
  },
];
